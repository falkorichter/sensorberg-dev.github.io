...
If you are using version 2.2.0 still, you are <strong>required to change the base URL</strong> in your Application class in a static initializer:
{% highlight java %}
static {		
...
<p>If you want to read up on the topic visit <a href="https://developer.android.com/about/versions/oreo/android-8.0-changes.html">developer.android.com/about/versions/oreo/android-8.0-changes.html</a>
</div>
...
<p>Please note that if you're using geofencing the ACCESS_FINE_LOCATION permission is required in your manifest. This is caused by Google Play Services requirements under the hood.</p><p>If ACCESS_FINE_LOCATION is not given you won't receive geofence notifications</p>
...
<div class="callout callout-info">
    ...
    <p>As as developer, you can create an account for free at <a href="https://portal.sensorberg.com/register">portal.sensorberg.com/register</a></p>
</div>
<div class="callout callout-info">
...
<div class="callout callout-info">
    ...
    <p>Read more about conversions in respective <a href="/2017/11/Streamlined-conversion-feature-on-Android-SDK-2-4/">Android</a> and <a href="/2016/06/New-conversion-feature-in-iOS-SDK/">iOS</a> blog posts.</p>
</div>
